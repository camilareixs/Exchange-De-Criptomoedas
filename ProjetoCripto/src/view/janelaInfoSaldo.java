...
public class janelaInfoSaldo extends javax.swing.JFrame {
    ...
    /**
     * Creates new form janelaInfoSaldo
     */
    public janelaInfoSaldo() {
    ...
    txtNomeSaldo.setText("Nome: " + control.getNome());
    txtCpfSaldo.setText("CPF: " + control.getCpf());
    txtReaisSaldo.setText("Reais: " + control.getSaldoReais());
    txtBitcoinSaldo.setText("Bitcoin: " + control.getSaldoBitcoin());
    txtEthereumSaldo.setText("Ethereum: " + control.getSaldoEthereum());
    txtRippleSaldo.setText("Ripple: " + control.getSaldoRipple());
}
