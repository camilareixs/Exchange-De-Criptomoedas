...
public class janelaCotacao extends javax.swing.JFrame {
    ...
    public janelaCotacao(Cotacao modelo) {
        ...
        exibirCotacoes(modelo.getValorBitcoin(), modelo.getValorEthereum(), modelo.getValorRipple());
        modelo = new Cotacao();
    ...
    public void exibirCotacoes(double valorBitcoin, double valorEthereum, double valorRipple) {
